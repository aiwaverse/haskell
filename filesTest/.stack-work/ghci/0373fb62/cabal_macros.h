...
/* package filesTest-0.1.0.0 */
#ifndef VERSION_filesTest
#define VERSION_filesTest "0.1.0.0"
#endif /* VERSION_filesTest */
#ifndef MIN_VERSION_filesTest
#define MIN_VERSION_filesTest(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_filesTest */
