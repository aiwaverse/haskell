...
setName :: (((String, Integer, Integer) -> ((String, Integer, Integer) -> t1) -> t1) -> t2) -> String -> t2
setName aRobot newName = aRobot (\(n, a, h) -> robot (newName, a, h))

setAttack :: (((String, Integer, Integer) -> ((String, Integer, Integer) -> t1) -> t1) -> t2) -> Integer -> t2
setAttack aRobot newAttack = aRobot (\(n, a, h) -> robot (n, newAttack, h))

setHp :: (((String, Integer, Integer) -> ((String, Integer, Integer) -> t1) -> t1) -> t2) -> Integer -> t2
setHp aRobot newHp = aRobot (\(n, a, h) -> robot (n, a, newHp))

printRobot :: (((String, Integer, Integer) -> String) -> String) -> String
printRobot aRobot = aRobot (\(n,a,h) -> "Name: " ++ n ++ " ,Attack: " ++ show a ++ " ,HP: " ++ show h)